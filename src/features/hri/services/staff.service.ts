...
export function GetListStaffService(payload: any) {
...
export function DeleteStaffService(payload: DTOStaff[]) {
  return apiHelper.post(HR_API.deleteStaff, {items: payload});
}